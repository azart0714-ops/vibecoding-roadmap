...
##### Правило 1: Начните с Vibe-PM-инга

**Концепция**: Попросите AI создать README с требованиями, технологическим стеком и этапами (до 5).
...
Включи:
1. Описание проекта и целевой аудитории
2. Технологический стек (выбери простой)
3. Основные требования и функции
4. Разбивку на 5 этапов разработки
5. Критерии готовности для каждого этапа

Первый этап должен быть максимально простым — что-то, что можно увидеть на экране за 30 минут."
```

**Пример этапов для игры**:
- **Этап 1**: Отображение 3D-модели на экране
- **Этап 2**: Добавление базового управления
- **Этап 3**: Реализация основной механики
- **Этап 4**: Добавление UI и звуков
...
**💡 Профессиональный совет**: **Grok** лучше справляется с планированием, чем Sonnet 3.7. Рассмотрите возможность написания README с помощью Grok и копирования его в Cursor.
