...
console.log("=== ЗАПУСК ВАЛИДАЦИОННЫХ ТЕСТОВ СЕМАНТИКИ (CYCLE 6) ===");
...
// Validate the 6 new Claude Code CLI Level 3 nodes presence and structure
const targetIds = [
  'l3_13_claude_code_guide',
  'l3_14_claude_code_modes',
  'l3_15_model_selection',
  'l3_16_new_features_v2',
  'l3_17_config_hierarchy',
  'l3_18_env_vars'
];
...
const expectedConnections = [
  ...
  { from: 'l3_18_env_vars', to: 'l4_1_private_git' }
];
...
if (failed) {
  ...
  console.log("⭐️ ВСЕ СЕМАНТИЧЕСКИЕ ТЕСТЫ CYCLE 6 УСПЕШНО ПРОЙДЕНЫ!");
  process.exit(0);
}
