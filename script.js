document.addEventListener("DOMContentLoaded", () => {
  ...
  const connectionsList = [
    ...
    // C1/C2 paradigm connections & new L0/L2/L3/L4/L6/L7/L8 topologies
    { from: "l0_6_savings_metrics", to: "l0_9_enterprise_adoption" },
    { from: "l0_9_enterprise_adoption", to: "l0_10_vibeops_metrics" },
    { from: "l0_10_vibeops_metrics", to: "l0_7_tools_cost" },
    { from: "lkey_context", to: "l0_8_guides_resources" },
    { from: "l1_5_project_checklists", to: "l1_6_vibepming" },
    { from: "l1_6_vibepming", to: "l1_7_backend_first" },
    { from: "l1_7_backend_first", to: "l2_19_autonomy_slider" },
    { from: "l2_18_commit_checklist", to: "l2_19_autonomy_slider" },
    { from: "l2_19_autonomy_slider", to: "l2_20_cursorrules_hygiene" },
    { from: "l2_20_cursorrules_hygiene", to: "l3_12_git_worktrees" },
    { from: "l3_11_github_prompts", to: "l3_12_git_worktrees" },
    { from: "l3_12_git_worktrees", to: "l4_11_deploy_strategy" },
    { from: "l4_10_reusable_blocks", to: "l4_11_deploy_strategy" },
    { from: "l4_11_deploy_strategy", to: "l5_9_docker_multicontainer" },
    { from: "l5_8_db_providers", to: "l5_9_docker_multicontainer" },
    { from: "l5_9_docker_multicontainer", to: "l7_3_postgres_neon" },
    ...
    { from: "l2_26_claude_prompt_templates", to: "l3_7_ide_comparison" },

    // L3 Custom Connections
    { from: "l3_7_ide_comparison", to: "l3_1_vscode" },
    { from: "l3_7_ide_comparison", to: "l3_2_claude_cli" },
    { from: "l3_7_ide_comparison", to: "l3_9_railway" },
    { from: "l3_6_terminal_cli", to: "l3_12_git_worktrees" },
    ...
    { from: "l4_36_screen_readers", to: "l4_37_design_tokens" },
    { from: "l4_37_design_tokens", to: "l4_38_dark_mode" },
    { from: "l4_38_dark_mode", to: "l4_39_focus_management" },
    { from: "l4_39_focus_management", to: "l4_40_framer_motion" },
    { from: "l4_40_framer_motion", to: "l4_41_prefers_reduced_motion" },
    { from: "l4_41_prefers_reduced_motion", to: "l4_42_form_validation" },
    { from: "l4_42_form_validation", to: "l4_43_input_states" },
    ...
    // L6 Custom Connections
    { from: "l6_4_pmf_validation", to: "l6_10_supabase_auth" },
    { from: "l6_10_supabase_auth", to: "l6_11_stripe_saas" },
    { from: "l6_11_stripe_saas", to: "l6_5_email_services" },
    { from: "l6_5_email_services", to: "l6_6_file_storage" },
    { from: "l6_6_file_storage", to: "l6_7_analytics_monitoring" },
    { from: "l6_7_analytics_monitoring", to: "l6_8_vercel_analytics" },
    { from: "l6_8_vercel_analytics", to: "l6_9_clerk_auth" },
    { from: "l6_9_clerk_auth", to: "l7_1_porting_vsc" },

    // L7 Custom Connections
    { from: "l7_7_design_systems", to: "l7_8_cicd_github_actions" },
    { from: "l7_8_cicd_github_actions", to: "l7_9_security_headers" },
    { from: "l7_9_security_headers", to: "l7_10_testing_principles" },
    { from: "l7_10_testing_principles", to: "l7_11_vercel_gold" },
    { from: "l7_11_vercel_gold", to: "l7_12_deploy_checklist" },
    { from: "l7_12_deploy_checklist", to: "l7_13_review_gate" },
    { from: "l7_13_review_gate", to: "l7_14_ai_error_patterns" },
    { from: "l7_14_ai_error_patterns", to: "l7_15_smart_testing" },
    { from: "l7_15_smart_testing", to: "l7_16_nightly_tests" },
    { from: "l7_16_nightly_tests", to: "l7_17_test_dashboard" },
    { from: "l7_17_test_dashboard", to: "l7_18_cli_automation" },
    { from: "l7_18_cli_automation", to: "l7_19_mobile_target_sizes" },
    { from: "l7_19_mobile_target_sizes", to: "l7_20_ai_playwright_e2e" },
    { from: "l7_20_ai_playwright_e2e", to: "l7_21_ci_cd_quality_gates" },
    { from: "l7_21_ci_cd_quality_gates", to: "l8_1_swarm_workflow" },

    // L8 Sequential AI Evolution Chain
    { from: "l8_1_swarm_workflow", to: "l8_2_playwright_testing" },
    { from: "l8_2_playwright_testing", to: "l8_3_subagents_orchestration" },
    { from: "l8_3_subagents_orchestration", to: "l8_4_rag_memory" },
    { from: "l8_4_rag_memory", to: "l8_5_agent_roles" },
    { from: "l8_5_agent_roles", to: "l8_6_vector_rag" },
    { from: "l8_6_vector_rag", to: "l8_7_load_testing" },
    { from: "l8_7_load_testing", to: "l8_8_mcp" },
    { from: "l8_8_mcp", to: "l8_9_skills_cookbook" },
    { from: "l8_9_skills_cookbook", to: "l8_10_agent_customization" },
    { from: "l8_10_agent_customization", to: "l8_11_mcp_architecture" },
    { from: "l8_11_mcp_architecture", to: "l8_12_swarm_patterns" },
    { from: "l8_12_swarm_patterns", to: "l8_13_swarm_orchestration" },
    { from: "l8_13_swarm_orchestration", to: "l8_14_hive_mind" },
    { from: "l8_14_hive_mind", to: "l8_15_handoff_protocol" },
    { from: "l8_15_handoff_protocol", to: "l8_16_specialized_roles" },
    { from: "l8_16_specialized_roles", to: "l8_17_superpowered_planning" },
    { from: "l8_17_superpowered_planning", to: "l8_18_agent_memory" },
    { from: "l8_18_agent_memory", to: "l8_19_pattern_recognition" },
    { from: "l8_19_pattern_recognition", to: "l8_20_recursive_skill" },
    { from: "l8_20_recursive_skill", to: "l8_21_subagent_development" },
    { from: "l8_21_subagent_development", to: "l8_22_subagent_stall_timeout" },
    { from: "l8_22_subagent_stall_timeout", to: "l8_23_swarm_review" },
    { from: "l8_23_swarm_review", to: "l8_24_ai_code_review_agent" },
    { from: "l8_24_ai_code_review_agent", to: "l8_25_claude_hooks" },
    { from: "l8_25_claude_hooks", to: "l8_26_security_hook" },
    { from: "l8_26_security_hook", to: "l8_27_chain_of_thought" },
    { from: "l8_27_chain_of_thought", to: "l8_28_context7_first" },
    { from: "l8_28_context7_first", to: "l8_29_zero_error_tolerance" },
    { from: "l8_29_zero_error_tolerance", to: "l8_30_red_flags" },
    { from: "l8_30_red_flags", to: "l8_31_multi_persona_testing" },
    { from: "l8_31_multi_persona_testing", to: "l8_32_consultant_mode" },
    { from: "l8_32_consultant_mode", to: "l8_33_batch_execution" },
    { from: "l8_33_batch_execution", to: "l8_34_skills" },
    { from: "l8_34_skills", to: "l8_35_superpowers_discipline" },
    { from: "l8_35_superpowers_discipline", to: "l8_36_claude_projects" },
    { from: "l8_36_claude_projects", to: "l8_37_lite_mode" },
    { from: "l8_37_lite_mode", to: "l8_38_pattern_learning" },
    { from: "l8_38_pattern_learning", to: "l8_39_instruction_distillation" },
    { from: "l8_39_instruction_distillation", to: "l8_40_rag" },
    { from: "l8_40_rag", to: "l8_41_cline" },
    { from: "l8_41_cline", to: "l8_42_superflow_workflow" },
    { from: "l8_42_superflow_workflow", to: "l8_43_minimize_tool_calls" },
    { from: "l8_43_minimize_tool_calls", to: "l8_44_dev_qa_cycle" },
    { from: "l8_44_dev_qa_cycle", to: "l8_45_role_systems" },
    { from: "l8_45_role_systems", to: "l8_46_agent_db_json" },
    { from: "l8_46_agent_db_json", to: "l8_47_long_term_kg" },
    { from: "l8_47_long_term_kg", to: "l8_48_parallel_subagents" },
    { from: "l8_48_parallel_subagents", to: "l8_49_optimized_triggers" },
    { from: "l8_49_optimized_triggers", to: "l8_50_qa_validation_prompt" }
  ];
